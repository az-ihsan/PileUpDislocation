...
*Dislocation pile-ups. From Hull & Bacon, 2011, Chapter 9*
...
*Velocity of dislocation according to overdamped motion where B is a drag coefficient and it is material-dependent.*
...
We neglect the presence of dislocation source, hence the number of dislocations in the system is constant and can be configured at the initial step (input). 
